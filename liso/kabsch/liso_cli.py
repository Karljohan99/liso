...
def main():
    log_dir_prefix = None
    args, cfg, maybe_slow_log_dir = load_handle_args_cfg_logdir(log_dir_prefix=log_dir_prefix)
    ...
    if args.profile or args.cprofile:
        ...
        cfg.optimization.rounds.steps_per_round = 2 * cfg.optimization.num_training_steps  # we dont want to profile the tracking
    ...
    if fast_test:
        ...
        cfg.optimization.num_training_steps = (_num_rounds * cfg.optimization.rounds.steps_per_round)
